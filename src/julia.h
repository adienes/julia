...
typedef struct {
    ...
    uint64_t err_params;      // bit 63 = configured; bits 0-62 = show bitvector for stacktrace type display
    uint64_t err_params_mode; // bits 0-62 = name-only bitvector for stacktrace type display
} jl_typename_t;
