...
void jl_init_types(void) JL_GC_DISABLED
{
    ...
    *(size_t*)jl_an_empty_string = 0;
    ...
    jl_svecset(jl_typename_type->types, 18, jl_uint64_type);
    jl_svecset(jl_typename_type->types, 19, jl_uint64_type);
